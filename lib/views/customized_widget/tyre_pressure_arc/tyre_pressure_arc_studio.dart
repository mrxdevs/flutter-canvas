...
class TyrePressureArcStudio extends StatefulWidget {
  const TyrePressureArcStudio({super.key});

  @override
  State<TyrePressureArcStudio> createState() => _TyrePressureArcStudioState();
}

class _TyrePressureArcStudioState extends State<TyrePressureArcStudio> {
  double width = 600;
  double height = 600;
  ...
  final _arcController = TyrePressureArcController();
