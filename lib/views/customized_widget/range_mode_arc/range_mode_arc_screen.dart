...
class RangeModeArc extends StatefulWidget {
  final double value;
...
class _RangeModeArcAnimationWidgetState extends State<RangeModeArc>
  ...
  @override
  void didUpdateWidget(covariant RangeModeArc oldWidget) {
...
class RangeModeArcPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final Paint arcModePaint = Paint()
