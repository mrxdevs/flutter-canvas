...
import 'package:flutter_canvas/views/customized_widget/arc_progress_bar.dart/arc_cercular_bar.dart';
...
class ArcProgressBarStudio extends StatefulWidget {
  const ArcProgressBarStudio({super.key});

  @override
  State<ArcProgressBarStudio> createState() => _ArcProgressBarStudioState();
}

class _ArcProgressBarStudioState extends State<ArcProgressBarStudio> {
  double width = 600;
  double height = 600;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Arc Progress Bar'),
        centerTitle: true,
        actions: [
          Padding(
